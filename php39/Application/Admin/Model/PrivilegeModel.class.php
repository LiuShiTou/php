...
{
	protected $insertFields = array('pri_name','action_name','controller_name','module_name','parent_id');
	protected $updateFields = array('id','pri_name','action_name','controller_name','module_name','parent_id');
