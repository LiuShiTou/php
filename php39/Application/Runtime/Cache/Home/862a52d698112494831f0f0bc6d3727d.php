...
<!-- 头部 start -->
	<div class="header w1210 bc mt15">
		...
		<div class="nav w1210 bc mt10">
			<!--  商品分类部分 start-->
			<div class="category fl <?php if($_show_nav==1) echo 'cat1'; ?>">
				<div class="cat_hd <?php if($_show_nav==1) echo 'off'; ?>">  <!-- 注意，首页在此div上只需要添加cat_hd类，非首页，默认收缩分类时添加上off类，并将cat_bd设置为不显示(加上类none即可)，鼠标滑过时展开菜单则将off类换成on类 -->
					<h2>全部商品分类</h2>
					<em></em>
				</div>
				
				<div class="cat_bd <?php if($_show_nav==1) echo 'none'; ?>"> 
					<!-- 循环输出三层分类数据 -->
...
$.ajax({
	...
	success:function(data){
		...
		$(data).each(function(k,v){
			html += "<tr>";
			html += '<td><img src="'+picView+v.mid_logo+'" /></td>';
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo $viewPath . $info['big_logo']; ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
