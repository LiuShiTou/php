        ...
        <form enctype="multipart/form-data" action="/index.php/Admin/Goods/edit/id/1.html" method="post">
            ...
            <table width="90%" class="tab_table" align="center">
                ...
                <tr>
                    ...
                    <td>
                        价格：￥<input type="text" name="promote_price" value="<?php echo $data['promote_price']; ?>" size="8"/>元
                        <span class="require-field">*</span>
                        开始时间：<input type="text" name="promote_start_date" value="<?php echo $data['promote_start_date']; ?>" id="promote_start_date" size="20"/>
                        <span class="require-field">*</span>
                        结束时间：<input type="text" name="promote_end_date" value="<?php echo $data['promote_end_date']; ?>" id="promote_end_date" size="20"/>
                        <span class="require-field">*</span>
                    </td>
                </tr>
                <tr>
