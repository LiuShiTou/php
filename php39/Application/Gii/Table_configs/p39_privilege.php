...
return array(
	...
	/********************* 要生成的模型文件中的代码 ******************************/
	// 添加时允许接收的表单中的字段
	'insertFields' => "array('pri_name','action_name','controller_name','module_name','parent_id')",
	// 修改时允许接收的表单中的字段
	'updateFields' => "array('id','pri_name','action_name','controller_name','module_name','parent_id')",
	'validate' => "
